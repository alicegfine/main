          ...
          <div key={dayIdx}>
            {editing ? (
              ...
              <button
                ...
                className="flex items-center gap-2 mb-4 group text-left"
              >
                <svg
                  className={`w-5 h-5 text-slate-400 group-hover:text-slate-600 transition-transform ${collapsedDays[dayIdx] ? "-rotate-90" : ""}`}
